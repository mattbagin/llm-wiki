...
Environment:
    ...
    WIKI_PASS1_MODEL  — override the Pass 1 (classifier) model.
    WIKI_PASS2_MODEL  — override the Pass 2 (evaluator) model.
"""
...
PASS1_MODEL = os.environ.get("WIKI_PASS1_MODEL", "claude-haiku-4-5")
PASS2_MODEL = os.environ.get("WIKI_PASS2_MODEL", "claude-sonnet-4-6")
